...
module.exports.run = async (bot, message, args) => {
    ...
    .addField('☑️ **__Free Commands:__**',' `;Help` | `;asciiface` | `;triggered <@Member>` | `;ascii <Text>` | `Image <Text>` | `;Avatar <@Member>` | `;Minecraft <ServerID>` | `;Kill <@Member>` | `;ServerInfo` | `;Info <@Member>` | `;Ping` | `;8ball <Text>` | `;Truth` | `;Dare`')
