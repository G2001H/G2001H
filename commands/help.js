...
module.exports.run = async (bot, message, args) => {
    ...
    .addField('👑 **__Administrator Commands:__**', "`;Purge <1-100>` | `;Kick <@Member> <Reason>` | `;Vote <@Member>` | `;Mute <@Member> <time> <Reason>` | `;Ban <@Member> <Reason>` | `;Poll <Text>` | `;ServerSetName <Text>`")
