...
module.exports.run = async (bot, message, args) => {
    ...
    .addField('**__Free Commands:__**', '`;Help`, `Image <Text>`, `;Avatar <@Member>`, `;Minecraft <ServerID>`, `;Kill <@Member>`, `;ServerInfo`, `;Info <@Member>`, `;Ping`, `;Im Verified?`, `;Im Owner?`, `;8ball <Text>`, `;Truth`, `;Dare`')
